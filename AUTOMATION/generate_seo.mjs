...
const staticUrls = [
  ...
  { loc: `${SITE_URL}/conceitos/ontologia/`, lastmod: null },
  { loc: `${SITE_URL}/conceitos/existencialismo/`, lastmod: null },
  { loc: `${SITE_URL}/conceitos/estoicismo/`, lastmod: null },
  { loc: `${SITE_URL}/conceitos/dialetica/`, lastmod: null },
  { loc: `${SITE_URL}/conceitos/ceticismo/`, lastmod: null },
  { loc: `${SITE_URL}/conceitos/hermeneutica/`, lastmod: null },
  { loc: `${SITE_URL}/conceitos/estetica/`, lastmod: null },
  { loc: `${SITE_URL}/conceitos/logica/`, lastmod: null },
